...
When investigating UI bugs with Codex Browser/browser-use, Playwright, or equivalent tools:

```bash
# Open the affected page with the available browser tool
open http://localhost:${PORT:-3000}/affected/route

# Capture current state with snapshots or screenshots

# Interact with the page using the available browser automation

# Save visual evidence
save a screenshot such as bug-evidence.png
```
